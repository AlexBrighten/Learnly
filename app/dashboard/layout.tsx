    ...
    return (
        <div className="min-h-screen bg-gray-50 text-foreground antialiased selection:bg-indigo-500/30 dark:bg-[#0a0f1c] dark:text-slate-200">
            <div className="flex h-screen overflow-hidden">
                <Sidebar className="hidden lg:block w-72 flex-shrink-0 border-r border-gray-200 bg-white dark:border-white/5 dark:bg-white/5 dark:backdrop-blur-xl" />

                <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
                    <Header className="h-20 flex-shrink-0 border-b border-gray-200 bg-white/80 backdrop-blur-xl z-10 dark:border-white/5 dark:bg-white/5" />
